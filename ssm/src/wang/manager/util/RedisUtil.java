...
public final class RedisUtil {
	 private static JedisPool pool = null;
	   ...
	   * @param timeout 超时时间
	   */
	  public RedisUtil(String ip, int prot,int timeout) {
	    if (pool == null) {
	...
	public static void initPool(){
		try {
			new RedisUtil(WeblogicUtil.getConfig().getRedisCacheIP(), WeblogicUtil.getConfig().getRedisCachePort(), WeblogicUtil.getConfig().getRedisCacheTimeOut());
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
